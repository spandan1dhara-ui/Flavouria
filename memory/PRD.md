...
- **Fuzzy correction fix**: only corrects on strong Fuse score (≤0.3) and never overwrites a word already in the vocabulary. Fixed paella→mozzarella, aloo posto→aloo potato while keeping biriyani→biryani, piza→pizza. (`lib/fuzzy.js`)
